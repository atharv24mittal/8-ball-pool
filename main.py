...
#load images
cue_image = pygame.image.load("pool/assets/cue.png").convert_alpha()
table_image = pygame.image.load("pool/assets/table.png").convert_alpha()
ball_images = []
for i in range(1, 17):
  ball_image = pygame.image.load(f"pool/assets/ball_{i}.png").convert_alpha()
